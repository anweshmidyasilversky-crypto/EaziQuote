...
function SubscriptionIndexPage() {
  ...
  return (
    <div className="m-6 flex flex-col items-center justify-center gap-12">
      ...
      <div className="min-h-136.25 min-w-112.5 dashboard-card-theme flex flex-col gap-2 rounded-[15px] bg-subcription-card-primary">
        <div className="min-h-22.5 w-full p-6 font-semibold text-[40px] text-center">
          {"$99/mo"}
        </div>
